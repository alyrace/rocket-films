    ...
    return (
      <div className="discover">
        ...
        <header className="discover-header">
          <h1
            className="discover-header__title wow fadeIn"
            data-wow-delay="1s"
          ...
          <form className="discover-header-form" method="GET" action="/">
            <div className="discover-header-form-container">
              <select
                className="discover-header-form-container-select wow fadeInUp"
                data-wow-delay=".6s"
                data-wow-duration="3s"
              ...
              >
                <option
                  className="discover-header-form-container-select__option"
              ...
              <input
                className="discover-header-form-container-input wow fadeInUp"
                data-wow-delay=".8s"
                data-wow-duration="3s"
              ...
              <input
                ...
                data-wow-delay="1s"
                data-wow-duration="3s"
                onChange={e => this.setState({ withPeople: e.target.value })}
                type="text"
                name="with_People"
            ...
            <button
              className="discover-header-form__button"
              onClick={e => {
                e.preventDefault();
        ...
        <main className="discover-main">
          {this.props.discover.results.length > 0 ? (
            this.props.discover.results.map(item => (
              <Link
                key={item.id}
              ...
              >
                <div className="discover-main-item">
                  <img
                    className="discover-main-item__image"
                    src={`${
                      this.props.MDBConfig.images
                        ? `${this.props.MDBConfig.images.secure_base_url}${
                            this.props.MDBConfig.images.poster_sizes[0]
                          }`
                        : ""
                    }${item.poster_path}`}
                    alt={item.name ? item.name : item.title}
                  />
                  <h3 className="discover-main-item__title">
                    {item.name ? item.name : item.title}
                  </h3>
                  <p className="discover-main-item-rating">
                    <svg
                      className="discover-main-item-rating__icon"
        ...
        <div className="discover-pagination">
          <button
            className="discover-pagination__button wow fadeIn"
            data-wow-delay=".5s"
            data-wow-duration="3s"
            onClick={() => {

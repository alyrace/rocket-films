...
class MainNav extends Component {
  ...
  componentDidMount() {
    ...
    setTimeout(() => {
      document
        .querySelectorAll(".main-nav-bottom-section__button")
        .forEach(button => {
          button.classList.add("fadeInLeft");
        });

      document
        .querySelector(".main-nav-top-section__image")
  ...
  render() {
    ...
    return (
      <nav className="main-nav">
        <div
          className={`main-nav-top-section ${
            !this.props.navStatus ? "main-nav-top-section--hide" : ""
          }`}
        >
          <Link to={"/"}>
            <img
              className="main-nav-top-section__image"
              src={logo}
              alt="logo"
            />
          </Link>
        ...
        <button
          ...
          className={`main-nav-toggle-button hamburger hamburger--elastic${
            this.props.navStatus ? " is-active" : ""
          }`}
          type="button"
        >
        ...
        <div
          className={`main-nav-bottom-section ${
            !this.props.navStatus ? "main-nav-bottom-section--hide" : ""
          }`}
        >
          <Link to={"/"}>

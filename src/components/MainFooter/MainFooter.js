    ...
    <footer className="main-footer">
      ...
      <section className="main-footer-top">
        ...
        <header className="main-footer-top-header">
          <h2 className="main-footer-top-header__title wow fadeInLeft" data-wow-delay=".5s" data-wow-duration="1.2s">Rocket Films</h2>
        ...
        <div className="main-footer-top-item">
          ...
          <p><a href="#" target="_blank" rel="noopener noreferrer">www.alysonrace.com</a></p>
        </div>

        <div className="main-footer-top-item">
          <h3 className="main-footer-top-item__title">email:</h3>
          <p>alysonrace@gmail.com</p>
        </div>

        <p className="main-footer-top-copyright">Copyright &copy;2019<br /> made with love and coffee by <a href="#" target="_blank" rel="noopener noreferrer">Alyson Race</a></p>
